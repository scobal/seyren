...
public class SeyrenConfig {
    ...
    private final Boolean ldapSsl;
    private final String ldapUserPattern;
    ...
    public SeyrenConfig() {
        ...
        this.authenticationEnabled = Boolean.parseBoolean(configOrDefault("AUTHENTICATION_ENABLED", "false"));
        this.adminUser = configOrDefault("ADMIN_USER", "admin");
        this.adminPass = configOrDefault("ADMIN_PASS", "admin");

        // LDAP Protocol
        this.ldapUrl = configOrDefault("LDAP_URL", "");
        this.ldapSsl = Boolean.parseBoolean(configOrDefault("LDAP_SSL", "false"));
        this.ldapUserPattern = configOrDefault("LDAP_USERPATTERN", "");
        this.ldapDomain = configOrDefault("LDAP_DOMAIN", "");
    }
