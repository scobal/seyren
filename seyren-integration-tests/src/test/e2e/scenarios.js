...
describe('check page', function () {
    ...
    it('should have a \'Details\' informations', function () {
        ...
        expect(element('div.col-lg-6 div.detail-form:eq(7) label').text()).toBe('Warn level:');
        expect(element('div.col-lg-6 div.detail-form:eq(7) p').text()).toBe('0.5');

        expect(element('div.col-lg-6 div.detail-form:eq(8) label').text()).toBe('Error level:');
        expect(element('div.col-lg-6 div.detail-form:eq(8) p').text()).toBe('1,000');
...
describe('create new check', function () {
    ...
    it('should have a \'Check\' modal dialog', function () {
        ...
        expect(element('div#editCheckModal img').attr('src')).toBe('./api/chart/karma.metric/?&width=365&height=70&from=-1day&warn=2.0&error=1000&hideLegend=true&graphiteBaseUrl=http://localhost:80');
